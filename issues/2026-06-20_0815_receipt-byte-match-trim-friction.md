...
> Triaged from a field debrief (a-separate-project session). Caller-side, not a gate bug — filed as a small UX-enhancement candidate. Separate change from the ambient-leak fix; not bundled.
